...
Promise.prototype.then = function (success, _failure) {
  console.log("in then this", this);
  waiting[this] = success;
};
...
Deferred.prototype.resolve = function (data) {
  ...
  // resolved[this.promise.status] = true;
  console.log("in resolve data", data);
  console.log("in resolve resolved", resolved);
  console.log("in resolve this", this);
};
...
var defer = function (value, status) {

  var promise = new Promise(value, status);
  var object = new Deferred(promise);
